package selenium_Core_Features.Synchronization_5;
...
public class Synchronization {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Implicit Wait - Applies to Whole Script : Each Step
		...
		driver.findElement(By.cssSelector("input.promoCode")).sendKeys("rahulshettyacademy");driver.findElement(By.cssSelector("button.promoBtn")).click();
